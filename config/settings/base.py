...
# Site domain for generating absolute URLs
...
LOCAL_APPS = [
    ...
    "hirethon_template.url_shortener",
...
MIDDLEWARE = [
    ...
    "hirethon_template.utils.middleware.CustomCsrfMiddleware",
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "hirethon_template.utils.authentication.CSRFExemptJWTAuthentication",
...
REST_AUTH = {
    ...
    "SESSION_LOGIN": False,
    "REGISTER_SERIALIZER": "hirethon_template.users.api.serializers.CustomRegisterSerializer",
